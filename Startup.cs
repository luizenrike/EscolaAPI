...
using EscolaAPI.Configurations;
...
namespace EscolaAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string ConnectionDatabase = Configuration.GetConnectionString("Default");
            services.AddDbContext<EscolaContext>(Options => Options.UseSqlServer(ConnectionDatabase));
